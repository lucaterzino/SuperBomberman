...
public class GameRenderer {
    ...
    public void drawHUD(int lives, int score, int enemiesKilled, double timeLeft, List<PowerUpType> activePowerUps) {
        ...
        // 3. Nemici Uccisi (Icona Teschio + Contatore)
        ...
        // 4. Punteggio (Icona Moneta + Valore)
        startX += 120;
        ...
        for (int r = 0; r < map.getRows(); r++) {
            for (int c = 0; c < map.getColumns(); c++) {
                ...
                if (type == TileType.WALL) {
                    ...
                    gc.fillRect(x, y, TILE_SIZE, 4); gc.fillRect(x, y, 4, TILE_SIZE);
                    gc.setFill(Color.web("#333333"));
                    gc.fillRect(x, y + TILE_SIZE - 4, TILE_SIZE, 4); gc.fillRect(x + TILE_SIZE - 4, y, 4, TILE_SIZE);
    ...
    private void drawPlayer(Player p) {
        ...
        gc.setFill(Color.BLACK); gc.fillRect(x + 14, y + 34, 20, 4);
        gc.setFill(Color.GOLD); gc.fillRect(x + 22, y + 34, 4, 4);
        gc.setFill(Color.WHITE); gc.fillRect(x + 10, y + 4, 28, 26); 
        gc.setStroke(Color.BLACK); gc.setLineWidth(2); gc.strokeRect(x + 10, y + 4, 28, 26);
        gc.setFill(Color.BLACK); gc.fillRect(cx - 6, y + 14, 4, 8); gc.fillRect(cx + 2, y + 14, 4, 8); 
        gc.strokeLine(cx - 8, y + 12, cx - 2, y + 16); gc.strokeLine(cx + 8, y + 12, cx + 2, y + 16);
        gc.setFill(Color.MAGENTA); gc.fillOval(x + 4, y + 24, 10, 10); gc.fillOval(x + 34, y + 24, 10, 10); 
        gc.fillOval(x + 10, y + 38, 12, 10); gc.fillOval(x + 26, y + 38, 12, 10); 
        gc.fillRect(cx - 4, y - 4, 8, 8);
    }

    private void drawEnemy(Enemy e) {
        double x = e.getX(); double y = e.getY(); double size = Enemy.SIZE; double cx = x + size/2; double cy = y + size/2;
    ...
    private void drawPowerUp(PowerUpType type, double x, double y) {
        // (Metodo helper usato per HUD e gioco)
        double s = PowerUp.SIZE;
        gc.setFill(powerUpColors.get(type)); gc.fillRect(x, y, s, s);
    ...
    // Overload per disegnare il PowerUp dal model
    ...
    public void drawPauseOverlay() {
         // Non usato se c'è il menu completo
